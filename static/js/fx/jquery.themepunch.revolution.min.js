...
!(function (t, e) {
  ...
  function i(i, d) {
    ...
    if (
      (i.data("aimg") != e &&
        (("enabled" == i.data("aie8") && s(8)) ||
          ("enabled" == i.data("amobile") && Z())) &&
        i.html(
          '<img class="tp-slider-alternative-image" src="' +
            i.data("aimg") +
            '">'
        ),
      ("preview1" == d.navigationStyle ||
        "preview3" == d.navigationStyle ||
        "preview4" == d.navigationStyle) &&
        ((d.soloArrowLeftHalign = "left"),
      ...
      (d.desktop = !navigator.userAgent.match(
      ...
      "on" == d.fullWidth &&
        "off" == d.autoHeight &&
        i.css({ maxHeight: d.startheight + "px" }),
      Z() &&
        "on" == d.hideThumbsOnMobile &&
        "thumb" == d.navigationType &&
        (d.navigationType = "none"),
      Z() &&
        "on" == d.hideBulletsOnMobile &&
        "bullet" == d.navigationType &&
        (d.navigationType = "none"),
      Z() &&
        "on" == d.hideBulletsOnMobile &&
        "both" == d.navigationType &&
        (d.navigationType = "none"),
      Z() && "on" == d.hideArrowsOnMobile && (d.navigationArrows = "none"),
      "on" == d.forceFullWidth &&
        0 == i.closest(".forcefullwidth_wrapper_tp_banner").length)
    ) {
    ...
    try {
      i.parent()
        ...
        .css(
          d.hideThumbsUnderResolution > t(window).width() &&
            0 != d.hideThumbsUnderResolution
            ? { display: "none" }
            : { display: "block" }
        );
    } catch (w) {}
    if (!i.hasClass("revslider-initialised")) {
      i.addClass("revslider-initialised"),
        i.attr("id") == e &&
          i.attr("id", "revslider-" + Math.round(1e3 * Math.random() + 5)),
        (d.firefox13 = !1),
      ...
      1 == y &&
        ...
        Z() &&
          i.find(".tp-caption").each(function () {
            var e = t(this);
            (1 == e.data("autoplayonlyfirsttime") ||
              "true" == e.data("autoplayonlyfirsttime")) &&
              e.data("autoplayonlyfirsttime", "false"),
              (1 == e.data("autoplay") || "true" == e.data("autoplay")) &&
                e.data("autoplay", !1);
          });
      var T = 0,
        k = 0,
        C = "http";
      if (
        ("https:" === location.protocol && (C = "https"),
        i.find(".tp-caption").each(function () {
          try {
            if (
              (t(this).data("ytid") != e ||
              ...
              t("head")
                .find("*")
                .each(function () {
                  t(this).attr("src") == i + "://www.youtube.com/iframe_api" &&
                    (o = !1);
                }),
          ...
          try {
            if (
              ...
              t("head")
                ...
                .each(function () {
                  t(this).attr("src") ==
                    C + "://a.vimeocdn.com/js/froogaloop2.min.js" && (o = !1);
                }),
        ...
        for (var I = 0; I < i.find(">ul:first-child >li").length; I++) {
          var A = Math.round(
            Math.random() * i.find(">ul:first-child >li").length
          );
          i.find(">ul:first-child >li:eq(" + A + ")").prependTo(
            i.find(">ul:first-child")
          );
        }
      ...
      (d.firststart = 1),
        ...
        0 == i.find(".tp-bannertimer").length &&
          i.append(
            '<div class="tp-bannertimer" style="visibility:hidden"></div>'
          );
      var D = i.find(".tp-bannertimer");
      if (
        (D.length > 0 && D.css({ width: "0%" }),
        ...
        (d.startheight == e || 0 == d.startheight) &&
          (d.startheight = i.height()),
        (d.width = i.width()),
        (d.height = i.height()),
        (d.bw = d.startwidth / i.width()),
        (d.bh = d.startheight / i.height()),
        d.width != d.startwidth &&
          ((d.height = Math.round(d.startheight * (d.width / d.startwidth))),
          i.height(d.height)),
        0 != d.shadow)
      ) {
        i.parent().append(
          '<div class="tp-bannershadow tp-shadow' + d.shadow + '"></div>'
        );
        var f = 0;
        "on" == d.forceFullWidth &&
          (f = 0 - d.container.parent().offset().left),
          i.parent().find(".tp-bannershadow").css({ width: d.width, left: f });
      }
      i.find("ul").css({ display: "none" });
      i.find("ul").css({ display: "block" }),
        v(i, d),
      ...
      t(window).on(H, function () {
        ...
        if (0 != t("body").find(i) && "on" == d.forceFullWidth) {
          ...
          d.container
            .parent()
            .css({ left: 0 - a + "px", width: t(window).width() });
        }
      ...
      try {
        0 != d.hideThumbsUnderResoluition &&
          "thumb" == d.navigationType &&
          t(".tp-bullets").css(
            d.hideThumbsUnderResoluition > t(window).width()
              ? { display: "none" }
              : { display: "block" }
          );
      } catch (w) {}
      ...
      var W = i.parent();
      t(window).width() < d.hideSliderAtLimit &&
        (i.trigger("stoptimer"),
        "none" != W.css("display") && W.data("olddisplay", W.css("display")),
        W.css({ display: "none" })),
        d.disableFocusListener ||
          "true" == d.disableFocusListener ||
          d.disableFocusListener === !0 ||
          n(i, d);
    }
  }
  t.fn.extend({
          ...
          if (1 == window.tplogs)
            try {
              console.groupCollapsed(
                "Slider Revolution 4.6.8 Initialisation on " +
                  t(this).attr("id")
              ),
    ...
    revscroll: function (a) {
      return this.each(function () {
        ...
        i != e &&
          i.length > 0 &&
          t("body").find("#" + i.attr("id")).length > 0 &&
          t("body,html").animate(
            {
    ...
    revredraw: function () {
      return this.each(function () {
        ...
        if (
          a != e &&
          a.length > 0 &&
          t("body").find("#" + a.attr("id")).length > 0
        ) {
    ...
    revnext: function () {
      return this.each(function () {
        ...
        a != e &&
          a.length > 0 &&
          t("body").find("#" + a.attr("id")).length > 0 &&
          a.parent().find(".tp-rightarrow").click();
      });
    },
    revprev: function () {
      return this.each(function () {
        ...
        a != e &&
          a.length > 0 &&
          t("body").find("#" + a.attr("id")).length > 0 &&
          a.parent().find(".tp-leftarrow").click();
      });
    },
    ...
    revshowslide: function (a) {
      return this.each(function () {
        ...
        i != e &&
          i.length > 0 &&
          t("body").find("#" + i.attr("id")).length > 0 &&
          (i.data("showus", a), i.parent().find(".tp-rightarrow").click());
      });
    },
  });
  var n =
    ...
    r = function (a, i) {
      ...
      t(window).width() < i.hideSliderAtLimit
        ...
        : a.is(":hidden") &&
          (o.css(
            o.data("olddisplay") != e &&
              "undefined" != o.data("olddisplay") &&
              "none" != o.data("olddisplay")
      ...
      y(a, i, a),
        ...
        l.find(".defaultimg").each(function () {
          var n = t(this);
          "on" == i.panZoomDisableOnMobile ||
            (n.data("kenburn") != e &&
              (n.data("kenburn").restart(), N(a, i, !0)));
        });
    ...
    d = function (t, e) {
      t.next == e.find(">ul >li").length - 1 &&
        ((t.looptogo = t.looptogo - 1), t.looptogo <= 0 && (t.stopLoop = "on")),
        L(e, t);
    },
    l = function (e, a) {
      var i = "hidebullets";
          ...
          i == a.slideamount - 1 && n.addClass("last"),
            ...
            n.click(function () {
              ...
              ("withbullet" == a.navigationArrows ||
                ...
                (i = n.index() - 1),
                i == a.act && (t = !0),
                0 != a.transition || t || ((a.next = i), d(a, e));
            });
        }),
    ...
    p = function (e, a) {
      var i = "vertical";
      "on" == a.touchenabled &&
        (1 == a.drag_block_vertical && (i = "none"),
        e.swipe({
          allowPageScroll: i,
    ...
    f = function (e, a) {
      ...
      "thumb" == a.navigationType &&
        ...
        "nexttobullets" == a.navigationArrows &&
          (r.prependTo(n).css({ float: "left" }),
          s.insertBefore(n.find(".tpclear")).css({ float: "left" }));
      var d = 0;
      ...
      if (
        ...
        r.css({ position: "absolute" }),
          ...
          "center" == c
            ...
            : "bottom" == c
              ? r.css({ top: "auto", bottom: 0 + g + "px" })
              : "top" == c && r.css({ bottom: "auto", top: 0 + g + "px" }),
          "center" == p
            ? r.css({
                left: "50%",
          ...
          "center" == u
            ...
            : "bottom" == u
              ...
              : "top" == u && s.css({ bottom: "auto", top: 0 + v + "px" }),
          "center" == f
            ? s.css({
                left: "50%",
      ...
      "none" == a.navigationArrows &&
        (r.css({ visibility: "hidden" }), s.css({ visibility: "hidden" }));
      ...
      "center" == b &&
        ...
        "bottom" == b && n.css({ bottom: 0 + x + "px" }),
        "top" == b && n.css({ top: 0 + x + "px" }),
        "center" == y &&
          n.css({
            left: "50%",
            marginLeft: d + T - Math.round(n.innerWidth() / 2) + "px",
          }),
        "left" == y && n.css({ left: 0 + T + d + "px" }),
        "right" == y && n.css({ right: 0 + T - d + "px" });
    },
    g = function (a) {
      var i = a.container;
      (a.beforli = a.next - 1),
      ...
      if (
        ...
        l.hasClass("itishovered") &&
          l.width(g.outerWidth(!0) + parseInt(l.css("minWidth"), 0)),
        h.hasClass("itishovered") &&
          h.width(m.outerWidth(!0) + parseInt(h.css("minWidth"), 0)),
        ...
        if ((d.addClass("hashoveralready"), Z())) {
          ...
          v.addClass("alwayshidden"),
            punchgs.TweenLite.set(v, { autoAlpha: 0 });
        } else
          d.hover(
            function () {
              var e = t(this),
      ...
      o.data("thumb") != e && (r = o.data("thumb")),
        ...
        d.hasClass("preview4")
          ...
          : (punchgs.TweenLite.to(c, 0.5, {
            ...
            punchgs.TweenLite.to(p, 0.5, {
              autoAlpha: 0,
              onComplete: function () {
                punchgs.TweenLite.to(c, 0.5, { autoAlpha: 1, delay: 0.2 }),
                  punchgs.TweenLite.to(p, 0.5, { autoAlpha: 1, delay: 0.2 });
              },
            })),
        l.hasClass("preview4") &&
        ...
        if (i.fullScreenOffsetContainer != e) {
          ...
          try {
            ...
            i.fullScreenOffset.length > 0
              ...
              : i.fullScreenOffset != e &&
                i.fullScreenOffset.length > 0 &&
                (n -= parseInt(i.fullScreenOffset, 0)),
              n < i.minFullScreenHeight && (n = i.minFullScreenHeight);
          } catch (r) {}
        }
    ...
    w = function (t, a, i, n) {
      ...
      r.data("currotate") != e && (l = r.data("currotate")),
        r.data("curscale") != e && "box" == n
          ? (d = 100 * r.data("curscale"))
      ...
      switch (n) {
        case "box":
          ...
          var L = 0,
            C = 0;
          "on" == o.data("kenburns") &&
            ((w = d), w.toString().length < 4 && (w = U(w, o, a)));
          for (var z = 0; z < a.slots; z++) {
            ...
            for (var O = 0; O < a.slots; O++)
              o.append(
                ...
                d != e &&
                  l != e &&
                  punchgs.TweenLite.set(o.find(".slot").last(), {
                    rotationZ: l,
                  });
            L += k;
          }
        ...
        a.css(
          ...
          setTimeout(function () {
            ...
            "center center" == o &&
              ...
              ("center top" == o || "top center" == o) &&
                a.css({
                  position: "absolute",
                  top: "0px",
                  left: e.width / 2 - i / 2 + "px",
                }),
              ("center bottom" == o || "bottom center" == o) &&
                a.css({
                  position: "absolute",
                  bottom: "0px",
                  left: e.width / 2 - i / 2 + "px",
                }),
              ("right top" == o || "top right" == o) &&
                a.css({ position: "absolute", top: "0px", right: "0px" }),
              ("right bottom" == o || "bottom right" == o) &&
                a.css({ position: "absolute", bottom: "0px", right: "0px" }),
              ("right center" == o || "center right" == o) &&
                a.css({
                  position: "absolute",
                  top: e.height / 2 - n / 2 + "px",
                  right: "0px",
                }),
              ("left bottom" == o || "bottom left" == o) &&
                a.css({ position: "absolute", bottom: "0px", left: "0px" }),
              ("left center" == o || "center left" == o) &&
                a.css({
                  position: "absolute",
                  top: e.height / 2 - n / 2 + "px",
                  left: "0px",
    ...
    L = function (t, a) {
      ...
      (a.bannertimeronpause = !0),
        ...
        (a.cd = 0),
        o.data("lazyload") != e &&
        "undefined" != o.data("lazyload") &&
        1 != o.data("lazydone")
          ? (s(8)
              ? o.attr("src", n.find(".defaultimg").data("lazyload"))
              : o.css({
                  backgroundImage:
                    'url("' + n.find(".defaultimg").data("lazyload") + '")',
                }),
    ...
    z = function (t, a) {
      ...
      var r = i.find(".slotholder"),
        s = o.find(".slotholder");
      ("on" == s.data("kenburns") || "on" == r.data("kenburns")) &&
        (J(t, a), t.find(".kenburnimg").remove()),
        o.data("delay") != e
          ? ((a.cd = 0), (a.delay = o.data("delay")))
          : (a.delay = a.origcd),
        1 == a.firststart && punchgs.TweenLite.set(i, { autoAlpha: 0 }),
    ...
    O = function (a, i, n, o, r, d) {
      ...
      "on" == n.data("randomtransition")
        ? (p = Math.round(Math.random() * c.length))
        : (p += 1),
        p == c.length && (p = 0),
        n.data("nexttransid", p);
      var u = c[p];
      i.ie &&
        ("boxfade" == u && (u = "boxslide"),
      ...
      "scroll" == i.parallax &&
        ...
        "slidehorizontal" == u &&
          ((u = "slideleft"), 1 == i.leftarrowpressed && (u = "slideright")),
        "slidevertical" == u &&
          ((u = "slideup"), 1 == i.leftarrowpressed && (u = "slidedown")),
        "parallaxhorizontal" == u &&
          ((u = "parallaxtoleft"),
      ...
      "on" == d.data("kenburns") &&
        ...
        N(a, i, !0, !0)),
        "random" == u &&
          ((u = Math.round(Math.random() * g.length - 1)),
          u > g.length - 1 && (u = g.length - 1)),
        "random-static" == u &&
          ((u = Math.round(Math.random() * m.length - 1)),
      ...
      (1 == i.leftarrowpressed || i.act > i.next) && (L = 1),
        ...
        0 > h && (h = 0);
      var C = 300;
      n.data("masterspeed") != e &&
        n.data("masterspeed") > 99 &&
        n.data("masterspeed") < i.delay &&
      ...
      if (
        (z.add(punchgs.TweenLite.set(d.find(".defaultimg"), { opacity: 0 })),
        z.pause(),
        n.data("slotamount") == e || n.data("slotamount") < 1
          ? ((i.slots = Math.round(12 * Math.random() + 4)),
            "boxslide" == u
              ? (i.slots = Math.round(6 * Math.random() + 3))
              : "flyin" == u && (i.slots = Math.round(4 * Math.random() + 1)))
          : (i.slots = n.data("slotamount")),
        (i.rotate =
          n.data("rotate") == e
            ? 0
            : 999 == n.data("rotate")
        ...
        d.find(".slotslide").each(function (e) {
          ...
          (A += 1),
            A == O && (A = 0),
            z.add(
              punchgs.TweenLite.from(a, C / 600, {
                opacity: 0,
                top: 0 - i.sloth,
                left: 0 - i.slotw,
                rotation: i.rotate,
      ...
      if (1 == h) {
        ...
        d.find(".slotslide").each(function (e) {
          ...
          n + o > M && ((M = o + o), (S = e)),
            z.add(
              punchgs.TweenLite.from(a, n / 1e3, {
                autoAlpha: 0,
                force3D: "auto",
                rotation: i.rotate,
      ...
      if (2 == h) {
        ...
        r.find(".slotslide").each(function () {
          ...
          d.find(".slotslide").each(function () {
            var e = t(this);
            P.add(
              punchgs.TweenLite.from(e, C / 1e3, {
                left: 0 - i.slotw,
                force3D: "auto",
                rotation: i.rotate,
              }),
      ...
      if (6 == h) {
        ...
        setTimeout(function () {
          ...
          r.find(".slotslide").each(function (e) {
            ...
            P.add(
              punchgs.TweenLite.to(a, (C + n) / 1e3, {
                top: 0 + i.height,
                opacity: 1,
                force3D: "auto",
                rotation: i.rotate,
          ...
          d.find(".slotslide").each(function (e) {
            ...
            P.add(
              punchgs.TweenLite.from(a, (C + n) / 1e3, {
                top: 0 - i.height,
                opacity: 1,
                force3D: "auto",
                rotation: i.rotate,
      ...
      if (12 == h || 13 == h || 14 == h || 15 == h) {
        ...
        ("on" == i.fullWidth || "on" == i.fullScreen) &&
          ...
          6 == f && (V = 1.4),
          (5 == f || 6 == f) &&
            ((q = 1.4), (B = 0), (W = 0), (X = 0), (Y = 0), (R = 0)),
          6 == f && (q = 0.6);
        z.add(
          punchgs.TweenLite.from(F, Z, {
            left: Y,
            top: R,
            scale: q,
            opacity: B,
      ...
      if (16 == h) {
        ...
        "on" == i.autoHeight && (X = a.height()),
          ...
          z.add(
            punchgs.TweenLite.set(o.find(".tp-half-two"), {
              width: W,
              height: X,
              overflow: "hidden",
              zIndex: 15,
          ...
          z.add(
            punchgs.TweenLite.set(o.find(".tp-half-one"), {
              width: W,
              height: X / 2,
              overflow: "visible",
              zIndex: 10,
        ...
        var $ = (o.find(".defaultimg"), Math.round(20 * Math.random() - 10)),
          ...
          te = 0.4 * Math.random() - 0.2,
          ee = 0.4 * Math.random() - 0.2,
          ae = 1 * Math.random() + 1,
          ie = 1 * Math.random() + 1,
          ne = 0.3 * Math.random() + 0.3;
        z.add(
          punchgs.TweenLite.set(o.find(".tp-half-one"), { overflow: "hidden" }),
          0
        ),
          z.add(
            punchgs.TweenLite.fromTo(
              ...
              },
              {
                ...
                onComplete: function () {
                  punchgs.TweenLite.set(o, {
                    ...
                    o.find(".tp-half-one").length > 0 &&
                      (o.find(".tp-half-one .defaultimg").unwrap(),
        ...
        d.find(".slotslide").each(function () {
          ...
          1 != L
            ? ((se = -i.width),
              (oe = 90),
              25 == h
                ? ((re = "center top 0"), (de = -oe), (oe = i.rotate))
                : ((re = "left center 0"), (de = i.rotate)))
            : ((se = i.width),
              (oe = -90),
              25 == h
                ? ((re = "center bottom 0"), (de = -oe), (oe = i.rotate))
                : ((re = "right center 0"), (de = i.rotate))),
          r.find(".slotslide").each(function () {
            var e = t(this);
            z.add(
              punchgs.TweenLite.fromTo(
    ...
    I = function (t, e, a, i, n, o, r) {
      punchgs.TweenLite.to(a.find(".defaultimg"), 0.001, {
        autoAlpha: 1,
        onComplete: function () {
          y(t, e, n);
        },
        ...
        i.addEvent("ready", function () {
          a && i.api("play"),
            ...
            r.find(".tp-thumb-image").click(function () {
              punchgs.TweenLite.to(t(this), 0.3, {
                autoAlpha: 0,
                force3D: "auto",
                ease: punchgs.Power3.easeInOut,
              }),
        ...
        p.each(function (a) {
          ...
          if (p.hasClass("tp-static-layer")) {
            ...
            (-1 == u || "-1" == u) && p.data("startslide", 0),
              ...
              0 == u &&
                f == i.slideamount - 1 &&
                p.data("endslide", i.slideamount + 1),
              (u = p.data("startslide")),
              (f = p.data("endslide")),
              p.hasClass("tp-is-shown")
                ? (l = f == i.next || u > i.next || f < i.next ? 2 : 0)
                : (u <= i.next && f >= i.next) || u == i.next || f == i.next
                  ? (p.addClass("tp-is-shown"), (l = 1))
                  : (l = 0);
          }
          ...
          "on" == i.fullScreen &&
            (c = i.height / 2 - (i.startheight * i.bh) / 2),
            ("on" == i.autoHeight || (i.minHeight != e && i.minHeight > 0)) &&
              (c = i.container.height() / 2 - (i.startheight * i.bh) / 2),
            0 > c && (c = 0);
          var m = 0;
          if (
            (i.width < i.hideCaptionAtLimit && "on" == p.data("captionhidden")
              ? (p.addClass("tp-hidden-caption"), (m = 1))
            ...
            if (
              ...
              var v = "iframe" + Math.round(1e5 * Math.random() + 1),
                ...
                I = "http",
                _ =
                  "loop" == p.data("videoloop")
                    ? "loop"
                    : "loopandnoslidestop" == p.data("videoloop")
                      ? "loop"
                      : "";
              if (
                (p.data("thumbimage") != e &&
                  p.data("videoposter") == e &&
                  p.data("videoposter", p.data("thumbimage")),
                x != e &&
                  String(x).length > 1 &&
                  0 == p.find("iframe").length &&
                  ((I = "https"),
                  "none" == O &&
                    ((y = y.replace("controls=1", "controls=0")),
                    -1 == y.toLowerCase().indexOf("controls") &&
                      (y += "&controls=0")),
                  p.append(
                ...
                T != e &&
                  String(T).length > 1 &&
                  0 == p.find("iframe").length &&
                  ("https:" === location.protocol && (I = "https"),
                  p.append(
                    '<iframe style="visible:hidden" src="' +
                      I +
                ...
                var B = "";
                (100 == w || "100%" == w) &&
                  (B = ";width:100% !important; height:100% !important");
                var E =
                ...
                p.data("videoposter") != e &&
                  p.data("videoposter") != e &&
                  (E = E + 'poster="' + p.data("videoposter") + '">'),
                  C != e &&
                    "firefox" == X().toLowerCase() &&
                    (E = E + '<source src="' + C + '" type="video/webm" />'),
                  L != e &&
                    (E = E + '<source src="' + L + '" type="video/mp4" />'),
                  z != e &&
                    (E = E + '<source src="' + z + '" type="video/ogg" />'),
                  (E += "</video>"),
                  p.append(E),
                  "controls" == O &&
                    p.append(
              ...
              (1 == p.data("autoplayonlyfirsttime") ||
                ...
                1 == p.data("autoplay")) &&
                (p.data("autoplay", !0), (j = !0)),
                p.data("videoposter") != e &&
                  p.data("videoposter").length > 2 &&
                  1 != p.data("autoplay") &&
                  !o &&
                  (0 == p.find(".tp-thumb-image").length
                    ? p.append(
                    ...
                    : punchgs.TweenLite.set(p.find(".tp-thumb-image"), {
                        autoAlpha: 1,
                      })),
                              ...
                              (r = new YT.Player(v, {
                                events: {
                                  ...
                                  onReady: function (a) {
                                    ...
                                    s != e &&
                                      a.target.setPlaybackRate(parseFloat(s)),
                                      ((!Z() && 1 == o.data("autoplay")) ||
                                        j) &&
                                        o.data(
                                          "timerplay",
                ...
                ((Z() && 1 == p.data("disablevideoonmobile")) || s(8)) &&
                  p.find("video").remove(),
                p.find("video").length > 0 &&
                          ...
                          if (
                            ...
                            if (
                              ...
                              o.addClass("HasListener"),
                                ...
                                n.attr("control") == e &&
                                  (0 ==
                                    o.find(".tp-video-play-button").length &&
                                    o.append(
                                  ...
                                  o
                                    .parent()
                                    .find(
                                      "video, .tp-poster, .tp-thumb-image, .tp-video-play-button"
                                    )
                                    .click(function () {
                              ...
                              t != e &&
                                ...
                                M(r, "click", function () {
                                  0 == a.muted
                                    ? ((a.muted = !0), (r.innerHTML = "Unmute"))
                                    : ((a.muted = !1), (r.innerHTML = "Mute"));
                                }),
                                M(s, "click", function () {
                                  a.requestFullscreen
                                    ? a.requestFullscreen()
                            ...
                            var c = 16 / 9;
                            if (
                              ("4:3" == p.data("aspectratio") && (c = 4 / 3),
                              o.data("mediaAspect", c),
                              1 ==
                                o.closest(".tp-caption").data("forcecover") &&
                                (P(o, i.container),
                                o.addClass("fullcoveredvideo")),
                              n.css({ display: "block" }),
                              (i.nextslideatend = p.data("nextslideatend")),
                              ...
                              o.data("ww") == e &&
                                o.data("ww", n.attr("width")),
                              o.data("hh") == e &&
                                o.data("hh", n.attr("height")),
                              !p.hasClass("fullscreenvideo") &&
                                1 == p.data("forcecover"))
                            )
                              try {
            ...
            if (p.find("img").length > 0) {
              var G = p.find("img");
              0 == G.width() && G.css({ width: "auto" }),
                0 == G.height() && G.css({ height: "auto" }),
              ...
              var $ = p.data("ww"),
                ...
                K = p;
              K.data("fsize") == e &&
                K.data("fsize", parseInt(K.css("font-size"), 0) || 0),
                K.data("pt") == e &&
                  K.data("pt", parseInt(K.css("paddingTop"), 0) || 0),
                K.data("pb") == e &&
                  K.data("pb", parseInt(K.css("paddingBottom"), 0) || 0),
                K.data("pl") == e &&
                  K.data("pl", parseInt(K.css("paddingLeft"), 0) || 0),
                K.data("pr") == e &&
                  K.data("pr", parseInt(K.css("paddingRight"), 0) || 0),
                K.data("mt") == e &&
                  K.data("mt", parseInt(K.css("marginTop"), 0) || 0),
                K.data("mb") == e &&
                  K.data("mb", parseInt(K.css("marginBottom"), 0) || 0),
                K.data("ml") == e &&
                  K.data("ml", parseInt(K.css("marginLeft"), 0) || 0),
                K.data("mr") == e &&
                  K.data("mr", parseInt(K.css("marginRight"), 0) || 0),
                K.data("bt") == e &&
                  K.data("bt", parseInt(K.css("borderTop"), 0) || 0),
                K.data("bb") == e &&
                  K.data("bb", parseInt(K.css("borderBottom"), 0) || 0),
                K.data("bl") == e &&
                  K.data("bl", parseInt(K.css("borderLeft"), 0) || 0),
                K.data("br") == e &&
                  K.data("br", parseInt(K.css("borderRight"), 0) || 0),
                K.data("lh") == e &&
                  K.data("lh", parseInt(K.css("lineHeight"), 0) || 0),
                "auto" == K.data("lh") && K.data("lh", K.data("fsize") + 4);
              var te = i.width,
                ee = i.height;
              if (
                (te > i.startwidth && (te = i.startwidth),
            ...
            "on" == i.fullScreenAlignForce && ((h = 0), (c = 0)),
            ...
            "on" == i.fullScreenAlignForce &&
              ((se = i.container.width()), (de = i.container.height())),
              ...
              ("left" == p.data("x") || "left" == p.data("xleft")) &&
                (p.data("xleft", "left"), p.data("x", 0 / g + re)),
              ...
              ("top" == p.data("y") || "top" == p.data("ytop")) &&
                (p.data("ytop", "top"), p.data("y", 0 / i.bh + oe)),
            ...
            if (
              ...
              p.data("timeline") == e ||
                o ||
                (2 != l && p.data("timeline").gotoAndPlay(0), (o = !0)),
              !o)
            ) {
              p.data("timeline") != e;
              ...
              p.data("mySplitText") != e && p.data("mySplitText").revert(),
                ("chars" == p.data("splitin") ||
                  ...
                  (p.find("a").length > 0
                    ? p.data(
                        "mySplitText",
                        new punchgs.SplitText(p.find("a"), {
                    ...
                    : p.find(".tp-layer-inner-rotation").length > 0
                      ? p.data(
                          "mySplitText",
                          new punchgs.SplitText(
                            p.find(".tp-layer-inner-rotation"),
                            {
                              type: "lines,words,chars",
                              charsClass: "tp-splitted",
                              wordsClass: "tp-splitted",
                  ...
                  p.addClass("splitted")),
                "chars" == p.data("splitin") &&
                  (ge = p.data("mySplitText").chars),
                "words" == p.data("splitin") &&
                  (ge = p.data("mySplitText").words),
                "lines" == p.data("splitin") &&
                  (ge = p.data("mySplitText").lines);
              var me = D(),
                ve = D();
              ...
              var we = p.attr("class");
              we.match("customin")
                ? (me = H(me, p.data("customin")))
                : we.match("randomrotate")
                  ...
                  : we.match("lfr") || we.match("skewfromright")
                    ? (me.x = 15 + i.width)
                    : we.match("lfl") || we.match("skewfromleft")
                      ? (me.x = -15 - U)
                      : we.match("sfl") || we.match("skewfromleftshort")
                        ? (me.x = -50)
                        : we.match("sfr") || we.match("skewfromrightshort")
                          ? (me.x = 50)
                          : we.match("lft")
                            ? (me.y = -25 - N)
                            : we.match("lfb")
                              ...
                              : we.match("sft")
                                ? (me.y = -50)
                                : we.match("sfb") && (me.y = 50),
                we.match("skewfromright") || p.hasClass("skewfromrightshort")
                  ? (me.skewX = -85)
                  : (we.match("skewfromleft") ||
                ...
                (we.match("fade") ||
                  ...
                  we.match("sfl") ||
                  we.match("sfb") ||
                  we.match("skewfromleftshort") ||
                  we.match("sfr") ||
                  we.match("skewfromrightshort")) &&
                  (me.opacity = 0),
                ...
                if (we.match("customin"))
                  ...
                  for (var a = 0; a < ge.length; a++) {
                    ...
                    t.extend(xe, me),
                      ...
                      fe.append(
                        punchgs.TweenLite.fromTo(ge[a], ce, xe, Te),
                        "frame0"
                      );
                  }
              ...
              (fe = p.data("timeline")),
                p.data("end") == e || (-1 != l && 2 != l)
                  ? -1 == l || 2 == l
                    ? q(p, i, 999999, me, "frame99", g)
                    : q(p, i, 999999, me, "frame99", g)
                  : q(p, i, p.data("end") / 1e3, me, "frame99", g),
                (fe = p.data("timeline")),
                p.data("timeline", fe),
                Y(p, g),
                fe.resume();
            ...
            t.each(Ce, function (t, a) {
              if (a.vars.data != e) {
                ...
                if (1 != a.progress() && 0 != a.progress())
                  ...
                  1 == a.progress() &&
                    punchgs.TweenLite.set(a.target, { x: i, y: n });
              }
            });
          }
        });
    ...
    F = function (t, a) {
      t.data("fsize") == e &&
        ...
        t.data("lh") == e &&
          t.data("lh", parseInt(t.css("lineHeight"), 0) || "auto"),
        t.data("minwidth") == e &&
      ...
      a.find(".rs-pendulum").each(function () {
        ...
        if (a.data("timeline") == e) {
          ...
          var n = a.data("startdeg") == e ? -20 : a.data("startdeg"),
            ...
            d =
              a.data("easing") == e ? punchgs.Power2.easeInOut : a.data("ease");
          (n *= i),
            (o *= i),
            a
              .data("timeline")
            ...
            a.data("timeline").append(
              new punchgs.TweenLite.fromTo(
                a,
                r,
                { force3D: "auto", rotation: o, transformOrigin: s },
                {
                  rotation: n,
                  ease: d,
                  onComplete: function () {
            ...
            (speed = a.data("speed") == e ? 2 : a.data("speed")),
              ...
              a.data("timeline").append(
                new punchgs.TweenLite.fromTo(
                  a,
                  speed,
                  { force3D: "auto", rotation: n, transformOrigin: origin },
                  {
                    rotation: o,
                    ease: easing,
                    onComplete: function () {
        ...
        a.find(".rs-wave").each(function () {
          ...
          if (a.data("timeline") == e) {
            ...
            (n *= i), (o *= i);
            var s = { a: 0, ang: n, element: a, unit: o };
            a.data("timeline").append(
              new punchgs.TweenLite.fromTo(
                s,
                r,
                { a: 360 },
                {
                  ...
                  onUpdate: function () {
                    ...
                    punchgs.TweenLite.to(s.element, 0.1, {
                      force3D: "auto",
                      x: Math.cos(t) * s.unit,
      ...
      return (
        ...
        o.each(function () {
          var a = -1,
            o = t(this);
          if (
            (o.hasClass("tp-static-layer") &&
              ((-1 == o.data("startslide") || "-1" == o.data("startslide")) &&
                o.data("startslide", 0),
              (-1 == o.data("endslide") || "-1" == o.data("endslide")) &&
                o.data("endslide", i.slideamount),
              o.hasClass("tp-is-shown")
                ? o.data("startslide") > i.next || o.data("endslide") < i.next
                  ? ((a = 2), o.removeClass("tp-is-shown"))
                  : (a = 0)
                : (a = 2)),
            0 != a)
          ) {
            ...
            try {
              ...
              if (p > u) {
                ...
                if (
                  ...
                  var g = o.data(
                    o.data("endspeed") == e ? "speed" : "endspeed"
                  );
    ...
    q = function (t, a, i, n, o, r) {
      ...
      if (
        ...
        c.match("skewtoright") || c.match("skewtorightshort")
          ? (l.skewX = 35)
          : (c.match("skewtoleft") || c.match("skewtoleftshort")) &&
            (l.skewX = -35),
                        ...
                        : c.match("stb")
                          ...
                          : c.match("randomrotateout")
                            ? ((l.x = Math.random() * a.width),
                              ...
                              (l.opacity = 0))
                            : c.match("fadeout") && (l.opacity = 0),
          c.match("skewtorightshort")
            ? (l.x = 270)
            : c.match("skewtoleftshort") && (l.x = -270),
          (l.data = new Object()),
          (l.data.oldx = l.x),
          (l.data.oldy = l.y),
          (l.x = l.x * r),
        ...
        "chars" == t.data("splitout")
          ...
          : "words" == t.data("splitout")
            ...
            : "lines" == t.data("splitout") &&
              (p = t.data("mySplitText").lines);
    ...
    j = function (a, i) {
      if (
        ...
        a.on("stoptimer", function () {
          ...
          e.data("tween").pause(),
            "on" == i.hideTimerBar && e.css({ visibility: "hidden" });
        }),
          a.on("starttimer", function () {
            1 != i.conthover &&
              ...
              1 == i.noloopanymore
                ? (i.noloopanymore = 1)
                : (n.css({ visibility: "visible" }), n.data("tween").resume())),
              "on" == i.hideTimerBar && n.css({ visibility: "hidden" });
          }),
        ...
        var o = function () {
          0 == t("body").find(a).length && (E(a, i), clearInterval(i.cdint)),
    ...
    Q = function (a, i) {
      return Z() && "on" == i.parallaxDisableOnMobile
        ? !1
        : (a.find(".tp-revslider-mainul >li").each(function () {
            for (var e = t(this), a = 1; 10 >= a; a++)
              e.find(".rs-parallaxlevel-" + a).each(function () {
                var e = t(this);
                e.wrapInner(
                  '<div style="position:relative;" class="tp-parallax-container" data-parallaxlevel="' +
                    i.parallaxLevels[a - 1] +
                    '"></div>'
                );
              });
          }),
          ("mouse" == i.parallax ||
            "scroll+mouse" == i.parallax ||
            "mouse+scroll" == i.parallax) &&
    ...
    ae = function (t, e) {
      punchgs.TweenLite.to(t.find(".tp-thumbcontainer"), 0.2, {
        force3D: "auto",
        left: e,
        ease: punchgs.Power3.easeOut,
        overwrite: "auto",
