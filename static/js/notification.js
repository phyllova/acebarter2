...
function notification() {
  spop({
    template:
      '<div class="sale_notification d-flex align-items-center"><img src="/login/assets/images/eng_flage.png" alt="" /> <div class="notification_inner"> <h3>$' +
      Math.floor(Math.random() * 6000 + 300) +
      "</h3><p>" +
      " " +
      words[Math.floor(Math.random() * 7)] +
      " BY <br><h3>" +
      names[Math.floor(Math.random() * 7)] +
      "</p></div></div>",
    group: "submit-satus",
